...
module Director
  class ConfigItemsController < BaseController
    ...
    PERMITTED_WHILE_ACTIVE = %w(display_capacity email_in_dev skip_stripe publicly_listed accept_payments automatic_discount_voids automatic_late_fees website)
