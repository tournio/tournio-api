...
class TournamentSerializer < JsonSerializer
  ...
  attribute :config do |t|
    %i(accept_payments bowler_form_fields display_capacity email_in_dev enable_free_entries enable_unpaid_signups publicly_listed team_size tournament_type website registration_without_payments).each_with_object({}) do |key, hash|
