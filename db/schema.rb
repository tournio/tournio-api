...
ActiveRecord::Schema[7.0].define(version: 2023_01_09_224615) do
  ...
  create_table "stripe_checkout_sessions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "payment_intent_identifier"
    ...
    t.index ["payment_intent_identifier"], name: "index_stripe_checkout_sessions_on_payment_intent_identifier"
  end
